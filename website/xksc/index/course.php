...
">
    <div class="mdui-typo">
        请注意，这里仅会展示最新的10条数据，如果您需要查看全部数据，请点击
...
$sql="SELECT id,title,content  FROM xksc_course order by id  desc limit 10";
...
while($row=mysqli_fetch_assoc($result))
{
    ...
    onclick=\"window.open('./xksc_show?class=course&id=".$id."');\">";
