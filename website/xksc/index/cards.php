...
<br>
    <!-- 卡片 MD配色 -->
<div class="mdui-card mdui-ripple mdui-hoverable" onclick="window.open('./xksc_md-color');">
    <!-- 卡片的媒体内容，可以包含图片、视频等媒体内容，以及标题、副标题 -->
    <div class="mdui-card-media">
...
<br>
        <!-- 卡片 氢应用 -->
<div class="mdui-card mdui-ripple mdui-hoverable" onclick="window.open('./xksc_tools-mian');">
    <!-- 卡片的媒体内容，可以包含图片、视频等媒体内容，以及标题、副标题 -->
    <div class="mdui-card-media">
    <div style="
    padding-top: 8vh;
