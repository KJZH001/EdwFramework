...
<!--最大容器 -->
  ...
  <!-- 基础网格 -->
	...
	<!-- 标题 -->
    <a href="javascript:;" class="mdui-typo-title 去超链接下划线 mdui-text-color-white">空梦框架-404</a>
	</div>
	...
	<div class="mdui-container">
		   ...
		   <div class="mdui-container">
				...
				<div class="mdui-typo mdui-center">
					<div class="mdui-typo-display-2">Error:这是一个错误的请求</div>
					 <br>
                     <center><p><strong>您已经安装过本框架了，如需重新安装
                     <br>请将框架根目录下的install.lock文件删除
                     </strong></p></center>
				</div>
				</center>
		   </div>
