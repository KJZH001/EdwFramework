...
本框架从底层开始，就已经考虑到了方便后续开发的相关问题，在框架中加入了纯PHP实现的伪静态功能，可以一定程度上解决部分虚拟主机支持多域名却无法绑定目录的问题

并且，我们在行为入口定义和以及接口方面都有着十分完善的逻辑性和一致化原则。当然如果您的服务器支持自定义伪静态的话您可以让连接地址实现更进一步的伪静态，将网址中的```/index.php/```去除

这是一个国产的PHP框架，所有有着相当良好的中文支持，我们也希望这个框架能够尽可能的减少初次接触PHP的人和编程初学者朋友们的上手难度，最难以上手的地方我们已经尽可能的为你铺好了路，不要畏惧，尽可能的去开发，挥霍你的创意吧！

朋友，不论你十分对对我们的项目产生了一定的兴趣还是想要参与到开发中来，我都真诚的邀请你下载来试一试

尽管它现在还不是那么的完善，也不是那么的完美。但是我相信，它有着能够让你满意的潜力和信心

在这介于虚幻于现实之间，而又万物皆可萌的世界之中，彼此的相遇，又会带来怎样的奇迹呢？
...
若您的开源项目使用了相关的开源项目中的并利用其获取收入，您必须将其开源，否则不得继续使用
...
框架主体采用MoeWorld License协议进行许可

大多数框架支持程序以GPL v3/AGPL协议进行许可

此外，工程中的一切项目都默认遵循Anti 996协议进行许可，抵制996工作制度是我们每个人都应做的事情和义务

只有这样才能更好的维护我们每个人的身体和生命以及财产权益

我们鼓励所有参与到永恒计划这个工程中的项目使用AGPL协议进行开源，但这并不强制（大型商业化使用除外）
